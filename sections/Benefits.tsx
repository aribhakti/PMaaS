      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {benefits.map((benefit, index) => (
          <FadeIn key={index} delay={index * 100}>
            <div className="group h-full flex flex-col items-start p-6 rounded-lg border border-border/50 hover:border-border bg-surface/20 hover:bg-surface/40 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-lg">
